...
extern const uint32_t CLOCK_MODE_DEFAULT;
extern const uint32_t TRIGGER_MODE_DEFAULT;
extern const uint32_t TRIGGER_EDGE_DEFAULT;
extern const uint32_t TRIGGER_GATE_DEFAULT;
